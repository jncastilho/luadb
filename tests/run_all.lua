...
for _, db_file in ipairs({ "temp_test.db", "employees.db", "json_test.db", "bugfix.db", "fk_test.db", "adv_test.db", "example_local.db", "reindex_test.db", "standalone_node.db", "cloud_database.db", "kamailio_cdr.db", "test_crud.db", "app.db", "test.db", "bugfix_test.db", "mydata.db", "luadb.db", "sql_spec_clean.db", "c_db_A.db", "c_db_B.db", "c_db_N1.db", "c_db_N2.db", "c_node_east.db", "c_node_west.db", "bind_test.db", "lock_test.db", "freelist_test.db", "wal_crash.db" }) do
    os.remove(db_file)
